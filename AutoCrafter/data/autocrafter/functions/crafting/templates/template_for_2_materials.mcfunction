...
# MATERIAL 2
# Set number of needed items
scoreboard players set @s material_2_count_needed 999


scoreboard players set @s temp_count 0
execute if block ~ ~1 ~ minecraft:dropper{Items:[{id:"minecraft:barrier", Slot:0b}]} store result score @s temp_count run data get storage autocrafter:crafting slots.0
scoreboard players operation @s material_2_count += @s temp_count
execute if score @s temp_count matches 1.. run data modify storage autocrafter:crafting slots_material_2 prepend value 0

scoreboard players set @s temp_count 0
execute if block ~ ~1 ~ minecraft:dropper{Items:[{id:"minecraft:barrier", Slot:1b}]} store result score @s temp_count run data get storage autocrafter:crafting slots.1
scoreboard players operation @s material_2_count += @s temp_count
execute if score @s temp_count matches 1.. run data modify storage autocrafter:crafting slots_material_2 prepend value 1

scoreboard players set @s temp_count 0
execute if block ~ ~1 ~ minecraft:dropper{Items:[{id:"minecraft:barrier", Slot:2b}]} store result score @s temp_count run data get storage autocrafter:crafting slots.2
scoreboard players operation @s material_2_count += @s temp_count
execute if score @s temp_count matches 1.. run data modify storage autocrafter:crafting slots_material_2 prepend value 2

scoreboard players set @s temp_count 0
execute if block ~ ~1 ~ minecraft:dropper{Items:[{id:"minecraft:barrier", Slot:3b}]} store result score @s temp_count run data get storage autocrafter:crafting slots.3
scoreboard players operation @s material_2_count += @s temp_count
execute if score @s temp_count matches 1.. run data modify storage autocrafter:crafting slots_material_2 prepend value 3

scoreboard players set @s temp_count 0
execute if block ~ ~1 ~ minecraft:dropper{Items:[{id:"minecraft:barrier", Slot:4b}]} store result score @s temp_count run data get storage autocrafter:crafting slots.4
scoreboard players operation @s material_2_count += @s temp_count
execute if score @s temp_count matches 1.. run data modify storage autocrafter:crafting slots_material_2 prepend value 4

scoreboard players set @s temp_count 0
execute if block ~ ~1 ~ minecraft:dropper{Items:[{id:"minecraft:barrier", Slot:5b}]} store result score @s temp_count run data get storage autocrafter:crafting slots.5
scoreboard players operation @s material_2_count += @s temp_count
execute if score @s temp_count matches 1.. run data modify storage autocrafter:crafting slots_material_2 prepend value 5

scoreboard players set @s temp_count 0
execute if block ~ ~1 ~ minecraft:dropper{Items:[{id:"minecraft:barrier", Slot:6b}]} store result score @s temp_count run data get storage autocrafter:crafting slots.6
scoreboard players operation @s material_2_count += @s temp_count
execute if score @s temp_count matches 1.. run data modify storage autocrafter:crafting slots_material_2 prepend value 6

scoreboard players set @s temp_count 0
execute if block ~ ~1 ~ minecraft:dropper{Items:[{id:"minecraft:barrier", Slot:7b}]} store result score @s temp_count run data get storage autocrafter:crafting slots.7
scoreboard players operation @s material_2_count += @s temp_count
execute if score @s temp_count matches 1.. run data modify storage autocrafter:crafting slots_material_2 prepend value 7

scoreboard players set @s temp_count 0
execute if block ~ ~1 ~ minecraft:dropper{Items:[{id:"minecraft:barrier", Slot:8b}]} store result score @s temp_count run data get storage autocrafter:crafting slots.8
scoreboard players operation @s material_2_count += @s temp_count
execute if score @s temp_count matches 1.. run data modify storage autocrafter:crafting slots_material_2 prepend value 8
# \------------------------------------------------------------------------------------------------------------------------------------------------------------------------/



execute if score @s material_1_count >= @s material_1_count_needed run scoreboard players set @s enough_material_1 1
execute if score @s material_2_count >= @s material_2_count_needed run scoreboard players set @s enough_material_2 1


execute if score @s enough_material_1 matches 1 if score @s enough_material_2 matches 1 run scoreboard players set @s enough_of_all_material 1
...
execute if score @s enough_of_all_material matches 1 unless data block ~ ~ ~ Items[0] run function autocrafter:crafting/functions/material_2/set_all_slots_of_material_2
