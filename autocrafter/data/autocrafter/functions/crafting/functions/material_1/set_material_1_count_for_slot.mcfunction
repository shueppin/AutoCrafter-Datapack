...
execute store result storage autocrafter:crafting new_item_count int 1 run scoreboard players operation @s new_number_of_items -= @s material_1_count_needed

function autocrafter:crafting/functions/set_new_item_count

scoreboard players operation @s calculating_material_count_needed = @s material_1_count_needed
scoreboard players operation @s calculating_material_count_needed += @s new_number_of_items
scoreboard players operation @s material_1_count_needed -= @s calculating_material_count_needed
